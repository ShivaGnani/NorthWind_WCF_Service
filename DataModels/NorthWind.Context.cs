...
namespace DataModels
{
    ...
    public partial class NORTHWINDEntities : DbContext
    {
        ...
        public virtual ObjectResult<spGetAllProductsByCategory_Result> spGetAllProductsByCategory(Nullable<int> categoryID)
        {
            var categoryIDParameter = categoryID.HasValue ?
                new ObjectParameter("categoryID", categoryID) :
                new ObjectParameter("categoryID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<spGetAllProductsByCategory_Result>("spGetAllProductsByCategory", categoryIDParameter);
        }
    
        public virtual ObjectResult<string> spValidateUser(string username, string password)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("spValidateUser", usernameParameter, passwordParameter);
        }
